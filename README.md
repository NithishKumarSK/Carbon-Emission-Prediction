...
| `2_data_exploration.ipynb` | Exploratory data analysis (EDA), visualizations          | [View on GitHub](https://github.com/NithishKumarSK/your-repo-name/blob/main/2_data_exploration.ipynb) |
| `3_model_building.ipynb`   | Model training (Random Forest), evaluation, prediction   | [View on GitHub](https://github.com/NithishKumarSK/your-repo-name/blob/main/3_model_building.ipynb) |
